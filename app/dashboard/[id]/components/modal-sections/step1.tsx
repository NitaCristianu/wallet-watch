    ...
    >
      ...
      <div className="-z-10 py-20 -my-20 overflow-hidden h-full w-full">
        <motion.div className="grid grid-cols-2 px-15 overflow-y-scroll w-full h-[60vh] to-black/10 ">
          {items.map((data) => (
            <motion.div
              className={`aspect-square  rounded-xl bg-gradient-to-b to-black/14 p-4 shadow-xl hover:scale-105 m-3 hover:to-black/30 transition duration-300`}
            ...
            >
              <div className="max-sm:hidden w-12 ml-5 mt-5 -mb-10 text-gray-200">
              ...
              <div className="flex justify-between h-full md:p-2">
                <div className="flex flex-col w-full h-full justify-end pb-2">
                  <h1 className=" text-gray-200 md:text-2xl capitalize font-semibold">
                    {data.title}
                  </h1>
